...
android {
    ...
    buildTypes {
        release {
            ...
            buildConfigField("String", "BASE_URL", "\"https://api.exory550.com/\"")
        ...
        debug {
            ...
            buildConfigField("String", "BASE_URL", "\"https://staging-api.exory550.com/\"")
    ...
    lint {
        ...
        abortOnError = true
        disable.addAll(setOf("TypographyFractions", "TypographyQuotes"))
    }
}
